...
// Function for registration
	...
	{
	$ret=mysqli_query($this->dbh,"insert into user(FullName,Username,UserEmail,Password) values('$fname','$uname','$uemail','$pasword')");
	return $ret;
	}
// Function for signin
public function signin($uname,$pasword)
	{
	$result=mysqli_query($this->dbh,"select id,FullName from user where Username='$uname' and Password='$pasword'");
	return $result;
	}
}
?>