...
<body>
    ...
    <form method="post">
        ...
        <input type="text" id="username" name="fullname" placeholder="fullname" required="true">

        <label for="username">Username</label>
        <input type="text" id="username" name="username" onblur="checkusername(this.value)" placeholder="username" required="true">
        <span id="usernameavailblty"></span>

        <label for="username">E-mail</label>
        <input type="email" id="email" name="email" placeholder="email" id="username" required="true">
